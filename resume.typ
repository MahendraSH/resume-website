...
#align(center)[
  ...
  #v(0.5mm)
  #text(size: 10pt, weight: "bold", fill: rgb("#2563eb"))[Java Cloud Full-Stack Engineer] \
  #v(0.5mm)
  #text(size: 8pt)[
    Hyderabad, India | +91-7892041114 | mahendrashongunti\@gmail.com | mahendrash.vercel.app \
    linkedin.com/in/mahendra-s-h-14a74721a | github.com/MahendraSH
  ]
]
...
#grid(
  columns: (1fr, auto),
  [*Infosys* --- Specialist Programmer], [Jul 2024 -- Jun 2026]
)
#v(0.2mm)
_Specialist Programmer (Hybrid) --- Hyderabad, India_
#v(0.2mm)
...
#v(0.2mm)
_Software Engineering Intern (Remote) --- Mysore, India_
#v(0.2mm)
...
*E-Commerce Platform (E-Store)* --- _Next.js, React, Tailwind CSS, Shadcn UI, Prisma ORM, MySQL, AWS S3_ \
- Built a full-stack e-commerce solution with admin capabilities for managing products, catalog categorization, and processing customer orders. Designed REST APIs deployed on Vercel with AWS S3.

#v(0.5mm)
*SpendOptima* --- _Next.js, React, Tailwind CSS, Recharts, TypeScript_ \
- Built a premium personal finance tracking and expense optimization dashboard featuring clean budget analytics. Designed responsive client dashboards with interactive statistics using Recharts.

#v(0.5mm)
*SaaS Form Builder Platform* --- _Next.js, React, Node.js, Express, PostgreSQL, AWS_ \
- Built a full-stack, no-code SaaS form builder allowing users to create dynamic forms. Created an embeddable script package and constructed secure REST APIs across 20+ client sites.

#v(0.5mm)
*Shadcn UI Form & Table Generators (Open-Source)* --- _Astro, React, TypeScript, TanStack Table v8, Shadcn UI, Zod_ \
- Published open-source developer tools that scaffold fully-typed Shadcn UI form schemas and TanStack Table v8 components from JSON/OpenAPI specs, reducing boilerplate setup time by 80%.
...
#v(0.2mm)
_Grade: 7.3 / 10 CGPA | Relevant Coursework: Data Structures, Database Systems, Software Engineering --- Mysore, India_

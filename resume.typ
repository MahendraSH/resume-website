...
#align(center)[
  #text(size: 15pt, weight: "bold")[Mahendra S H] \
  #v(0.4mm)
  #text(size: 9.5pt, weight: "bold", fill: rgb("#2563eb"))[Java Cloud Full-Stack Engineer | Java | Spring Boot | React | Microservices | AWS] \
  #v(0.4mm)
  #text(size: 7.5pt)[
...
#grid(
  columns: (1fr, auto),
  [*Infosys* --- Specialist Programmer / Software Developer], [Jul 2024 -- Jun 2026]
)
#v(0.1mm)
_Hyderabad, India_
#v(0.1mm)
...
#grid(
  columns: (1fr, auto),
  [*Independent Software Development* --- Freelance Frontend & MERN Developer], [Jun 2023 -- Jun 2024]
)
#v(0.1mm)
_Mysore, India_
#v(0.1mm)
...
*Cargo Readiness --- CMA CGM Project* • _Java 21, Spring Boot, Microservices, Kafka, AWS SNS/SQS/S3, Camunda, Spring Batch, React, PostgreSQL_ \
...
#v(0.3mm)
*ProjectX --- Generative AI Shirt Studio* • _Next.js, React, TypeScript, Node.js, AWS S3, Tailwind CSS_ \
...
#v(0.3mm)
*E-Commerce Platform* • _Next.js, React, Tailwind CSS, Shadcn UI, Prisma ORM, MySQL, AWS S3_ \
...
#v(0.3mm)
*Shadcn UI Form & Table Generators* • _Astro, React, TypeScript, TanStack Table v8, Shadcn UI, Zod_ \
...
#grid(
  columns: (1fr, auto),
  [*National Institute of Engineering (NIE)* --- B.Tech in Computer Science & Engineering], [Graduated May 2024]
)
#v(0.1mm)
_CGPA: 7.3 / 10 | Relevant Coursework: Data Structures & Algorithms, Database Systems, Software Engineering, DBMS, Object-Oriented Design --- Mysore, India_

      ...
      <div className="max-w-3xl w-full px-4 md:px-8">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-muted-foreground text-sm max-w-md mx-auto leading-relaxed">
            I am open to discussing new opportunities, collaboration ideas, or
            simply answering questions. Feel free to contact me using any of the
            channels below.
          </p>
        </div>
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
          ...
          <div className="glass-panel p-5 rounded-xl flex items-center gap-4 md:col-span-2">
            ...
            <div className="text-left">
              ...
              <div className="text-sm font-medium">Karnataka, India</div>
            </div>
          </div>
        </div>
      </div>
